    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p class="mt-10 text-center text-sm/6 text-gray-500">
                Not a member?
                <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Lorem, ipsum dolor sit
                    amet consectetur adipisicing elit. At eos ipsum quibusdam impedit dicta aspernatur, quasi officiis
                    quod ut beatae ullam magni id adipisci nihil dolore quae enim. Harum, accusantium!</a>
            </p>
        </div>
    </div>
